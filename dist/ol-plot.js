...
(function (global, factory) {
  ...
  (global = global || self, global.olPlot = factory(global.ol, global.interaction, global.style, global.Feature, global.Draw, global.layer, global.source, global.geom, global.Polygon$1, global.extent_js, global.color, global.extent));
}(this, function (ol, interaction, style, Feature, Draw, layer, source, geom, Polygon$1, extent_js, color, extent) { 'use strict';
  ...
  var RectAngle = function (_$Polygon) {
    ...
    _proto.generate = function generate() {
      if (this.points.length === 2) {
        ...
        if (this.isFill) {
          var extent = extent_js.boundingExtent(this.points);
          var polygon = Polygon$1.fromExtent(extent);
  ...
  var PlotDraw = function (_Observable) {
    ...
    _proto.activeInteraction = function activeInteraction() {
      this.drawInteraction_ = new interaction.Draw({
        style: new style.Style({
          fill: new style.Fill({
  ...
  var StyleFactory = function StyleFactory(options) {
    ...
    if (option['geometry'] && option['geometry'] instanceof geom.Geometry) {
  ...
  var PlotUtils = function () {
    ...
    _proto.getBaseStyle = function getBaseStyle(feature) {
      ...
      if (!style) {
        ...
        if (layer$1 && layer$1 instanceof layer.Vector) {
    ...
    _proto.getImage_ = function getImage_(style$1) {
      ...
      if (style$1) {
        ...
        if (olStyle_) {
          ...
          if (olStyle_ instanceof style.Icon) {
            image['type'] = 'icon';
            image['image'] = {};
          ...
          } else if (olStyle_ instanceof style.RegularShape) {
            image['type'] = '';
            image['image'] = {};
    ...
    _proto.getStyleCode = function getStyleCode(feature) {
      try {
        if (feature && feature instanceof Feature) {
          ...
          if (style$1 && style$1 instanceof style.Style) {
          ...
          if (features && features.length > 0) {
            features.forEach(function (feature, index) {
              if (feature && feature.getGeometry) {
                rFeatures.push(_this.jsonFeature(feature));
              }
            });
          }
        }
    ...
    _proto.jsonFeature = function jsonFeature(feature) {
    ...
    _proto.addFeatures = function addFeatures(features, funWrap) {
      var _this2 = this;
  ...
  _defineProperty(olPlot, "PlotTypes", PlotTypes);

  _defineProperty(olPlot, "Geometry", Geometry);
