 ...
 */
import { Map as Map$1, Overlay } from 'ol';
import { DragPan, Draw, DoubleClickZoom } from 'ol/interaction';
import { Style, Fill, Stroke, Circle as Circle$1, Icon, RegularShape, Text } from 'ol/style';
import Feature from 'ol/Feature';
import { createBox } from 'ol/interaction/Draw';
import { Vector, Group } from 'ol/layer';
import { Vector as Vector$1 } from 'ol/source';
import { Point as Point$1, LineString, Polygon as Polygon$1, Geometry as Geometry$1 } from 'ol/geom';
...
var PlotUtils = function () {
  ...
  _proto.handleBackgroundColor = function handleBackgroundColor(color, opacity) {
    try {
  ...
  _proto.getColor = function getColor(color) {
    try {
  ...
  _proto.getImage_ = function getImage_(style) {
    var image = null;
        ...
        if (source && source instanceof Vector$1) {
          ...
          features.forEach(function (feature, index) {
            if (feature && feature['geometry'] && feature['geometry']['type'] !== 'PlotText') {
              ...
              _extents.push(new Point$1(feature.geometry['coordinates']).getExtent());
...
//# sourceMappingURL=ol-plot.esm.js.map
